...
export default function Contact() {
  return (
    <div className=" bg-white py-20 px-2 overflow-hidden relative z-10">
              ...
              <div className="w-full lg:w-1/2 xl:w-6/12 px-4">
                <div className="max-w-[570px] mb-12 lg:mb-0">
                  ...
                  <p className="text-base text-body-color leading-relaxed mb-9">
                    Công ty Công nghệ phần mềm Gofiber là công ty cung cấp đầy
                    đủ các dịch vụ website về cá cược online đảm bảo tiêu chuẩn
                  ...
                  <div className="flex mb-8 max-w-[370px] w-full">
                    ...
                    <div className="w-full">
                      ...
                      <p className="text-base text-body-color">
                        Tầng 3B, Tòa Nhà Scetpa, 19A Cộng Hòa, Phường 12, Quận
                  ...
                  <div className="flex mb-8 max-w-[370px] w-full">
                    ...
                    <div className="w-full">
                      ...
                      <p className="text-base text-body-color">0908195336</p>
                    </div>
                  </div>
                  <div className="flex mb-8 max-w-[370px] w-full">
                    <div
