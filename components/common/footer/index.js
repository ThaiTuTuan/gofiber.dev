...
function Footer() {
  return (
    <>
      <footer className="p-4 bg-white sm:p-6 dark:bg-blue-100 ">
        <div className="container mx-auto">
          <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0">
              ...
              <h3 className="uppercase font-semibold py-2">
                Công ty công nghệ phần mềm Gofiber
              </h3>
              <p>
                Địa chỉ: Tầng 3B, Tòa Nhà Scetpa, 19A Cộng Hòa, Phường 12, Quận
                Tân Bình, Thành phố Hồ Chí Minh, Việt Nam
              </p>
              {/* <p>Điện thoại: 0908195336</p> */}
            </div>
          ...
          <hr className="my-6 sm:mx-auto border-gray-700 lg:my-6" />
